                ...
                <div class="col-12 col-md-6 d-flex">
                    <div class="list-item list-item-overlay custom-hover flex-fill">
                        ...
                        <div class="media d-flex flex-fill">
                            <a href="{{ $firstSlide->getLink() }}" class="media-content"
                               style="background-image: url('{{ $firstSlide->getImage() ?? $slideBg }}')">
                                <span class="overlay"></span>
                            </a>
                        </div>
                        <div class="list-content">
                            <div class="list-body">
                                <a href="{{ $firstSlide->getLink() }}" class="list-title text-lg h-2x"
                                   target="_blank">
                                    {{ $firstSlide->getName() }}
                                </a>
                            </div>
                            ...
                            @foreach($slides->slice(1,4)->all() as $slide)
                                <div class="col-6 py-1 py-md-2">
                                    <div class="list-item list-item-overlay custom-hover">
                                        <div class="media">
                                            <a href="{{ $slide->getLink() }}" class="media-content"
                                               style="background-image: url('{{ $slide->getImage() ?? $slideBg }}')">
                                                <span class="overlay"></span>
                                            </a>
                                        </div>
                                        <div class="list-content">
