...
/***/ "./resources/ts/app/Cosy.ts":
/*!**********************************!*\
  !*** ./resources/ts/app/Cosy.ts ***!
  \**********************************/
/*! exports provided: popup, Cosy, app */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "popup", function() { return popup; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Cosy", function() { return Cosy; });
...
/* harmony import */ var _utils_highlight__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/highlight */ "./resources/ts/app/utils/highlight.ts");
...
function popup(type, html, maskStyle, btnCallBack) {
  ...
  `;
    const popup = jquery__WEBPACK_IMPORTED_MODULE_2___default()(template);
    jquery__WEBPACK_IMPORTED_MODULE_2___default()('#app').append(popup);
    ...
    const close = function () {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(popup).removeClass('cosy-tips-open');
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(popup).addClass('cosy-tips-close');
        setTimeout(function () {
            jquery__WEBPACK_IMPORTED_MODULE_2___default()(popup).removeClass('cosy-tips-close');
            setTimeout(function () {
                popup.remove();
            }, 200);
        }, 600);
    };
    jquery__WEBPACK_IMPORTED_MODULE_2___default()(popup).on('click', '.btn-close-tips, .cosy-tips-overlay', function (e) {
        e.preventDefault();
        close();
    });
    if (typeof btnCallBack === 'object') {
        Object.keys(btnCallBack).forEach(function (key) {
            jquery__WEBPACK_IMPORTED_MODULE_2___default()(popup).on('click touchstart', key, function (event) {
...
class Cosy {
    constructor(config) {
        this.app = null;
        this.bus = new vue__WEBPACK_IMPORTED_MODULE_0__["default"]();
    ...
    loaded() {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()('.back-to-top').off('click').on('click', function (e) {
            e.preventDefault();
            jquery__WEBPACK_IMPORTED_MODULE_2___default()('html, body').stop().animate({ scrollTop: 0 }, 600);
        });
        jquery__WEBPACK_IMPORTED_MODULE_2___default()('.search-popup').off('click').on('click', function (e) {
            e.preventDefault();
            popup('full', jquery__WEBPACK_IMPORTED_MODULE_2___default()('#search-popup-wrap').html());
        });
        const sidebar = jquery__WEBPACK_IMPORTED_MODULE_2___default()(".sidebar");
        ...
        const postContainer = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#post");
        if (postContainer !== undefined) {
            _utils_highlight__WEBPACK_IMPORTED_MODULE_4__["Highlight"].highlight();
        }
    }
    /**
    ...
    liftOff() {
        ...
        this.app = new vue__WEBPACK_IMPORTED_MODULE_0__["default"]({
            el: '#app',
            components: {},
            mounted: function () {
                // this.$loading = this.$refs.loading;
                // NProgress.start();
                that.$on('error', (message) => {
    ...
    loadPjax() {
        const that = this;
        const container = jquery__WEBPACK_IMPORTED_MODULE_2___default()(document);
    ...
    thirdShare(type, url, title, img, desc) {
        console.log(url, type, title, img, desc);
    }
}
const app = new Cosy(window.config);
(function () {
    app.boot();
    app.loaded();
})();
...
__webpack_require__(/*! ./utils/pjax */ "./resources/ts/app/utils/pjax.ts");
__webpack_require__(/*! ./utils/highlight */ "./resources/ts/app/utils/highlight.ts");
__webpack_require__(/*! ./utils/backtop */ "./resources/ts/app/utils/backtop.ts");
/**
...
document.addEventListener('DOMContentLoaded', () => {
    pangu__WEBPACK_IMPORTED_MODULE_0___default.a.spacingPage();
});
...
/***/ "./resources/ts/app/utils/backtop.ts":
/*!*******************************************!*\
  !*** ./resources/ts/app/utils/backtop.ts ***!
  \*******************************************/
/*! no exports provided */
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
    const onScroll = () => {
        const thisWindow = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window);
        const container = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#back-to-top");
        const windowW = thisWindow.width();
        const windowH = thisWindow.height();
        const offset = thisWindow.scrollTop();
        const startPoint = windowH / 2;
        if (offset > 72) {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('.fixed-top').addClass('scroll');
        }
        else {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('.fixed-top').removeClass('scroll');
        }
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('scroll', onScroll);
    onScroll();
});
...
/***/ "./resources/ts/app/utils/highlight.ts":
/*!*********************************************!*\
  !*** ./resources/ts/app/utils/highlight.ts ***!
  \*********************************************/
...
/***/ "./resources/ts/app/utils/pjax.ts":
/*!****************************************!*\
  !*** ./resources/ts/app/utils/pjax.ts ***!
  \****************************************/
/*! no exports provided */
...
/* harmony import */ var _Cosy__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Cosy */ "./resources/ts/app/Cosy.ts");



__webpack_require__(/*! jquery-pjax */ "./node_modules/jquery-pjax/jquery.pjax.js");
(function () {
    const container = jquery__WEBPACK_IMPORTED_MODULE_0___default()(document);
    container.pjax('a:not(a[target="_blank"])', '#app', { timeout: 1600, maxCacheLength: 500 });
    container.on('pjax:start', function () {
    ...
    container.on('pjax:end', function () {
        ...
        console.log(1);
        _Cosy__WEBPACK_IMPORTED_MODULE_2__["app"].loaded();
    });
})();
